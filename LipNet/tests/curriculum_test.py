...
def show_results(_video, _align, video, align):
    ...
    print("Video: ")
    print(_video.length)
    print(np.array_equiv(_video.mouth, video.mouth), end=' ')
    print(np.array_equiv(_video.data, video.data), end=' ')
    ...
    print(np.array_equiv(_align.sentence, align.sentence), end=' ')
    print(np.array_equiv(_align.label, align.label), end=' ')
